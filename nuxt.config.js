module.exports = {
  ...
  */
  head: {
    ...
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/icon_logo.png' },
      // iconfont class
      { rel: 'stylesheet', type: 'text/css', href: 'https://at.alicdn.com/t/font_1360760_m5i8wwqcqaq.css' },
    ],
    script: [
      // iconfont svg
      { rel: 'script', type: 'text/javascript', src: 'https://at.alicdn.com/t/font_1360760_m5i8wwqcqaq.js' },
      {
          rel: 'script',
      ...
      },
      {
          ...
          async: 'async',
          src:
              'https://ykf-webchat.7moor.com/javascripts/7moorInit.js?accessId=81b474d0-0430-11ea-959c-cfbc3ad39d7f&autoShow=true&language=ZHCN',
      },
    ],
  },
  /*
  ...
  */
  loading: { color: '#E9047B' },
  /*
  ** Global CSS
  */
  css: [
    { src: '~/assets/style/reset.less', lang: 'less' },
    { src: '~/assets/style/common.less', lang: 'less' },
  ],
  /*
