                ...
                <div class="module formItem">
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="item">
                                <p>特色体验（{{orderInfo.documentType | ticketType}}）</p>
                            </div>
                        </li>
                        <li>
                            <div class="label">
                                ...
                                <FormItem prop="payType">
                                    <RadioGroup v-model="form.payType" @on-change="changePayType">
                                        ...
                                        >
                                            <p>
                                                现付&nbsp;
                                                <span>&yen;{{preOptions[0].paymentPrice*1}}</span>/人
                                            </p>
                                        </Radio>
                                    </RadioGroup>
                                </FormItem>
...
export default {
        ...
        return {
            ...
            rules: {
                ...
                contactName: [
                    ...
                    {
                        required: true,
                        pattern: REG.contactName,
                        message: '请输入20位以下的中文或英文字符',
                        trigger: 'blur',
                    },
                ],
    ...
    methods: {
        ...
        submitForm() {
            ...
            if (this.orderInfo.maximumOrderQuantity && this.form.bookingNum > this.orderInfo.maximumOrderQuantity) {
            ...
            this.$refs.form.validate(res => {
                if (res) {
                    ...
                    if (this.orderInfo.cancelable) {
                        cancelPolicy.canCancel = true;
                        cancelPolicy['ladders'] = this.orderInfo.cancelPolicy;
                    } else {
                        cancelPolicy.canCancel = false;
                    }
                    let data = {
                        ...this.form,
                        cityId: this.orderPre.cityId * 1,
                        skuId: this.orderPre.skuId,
                        resourceId: this.orderInfo.resourceId * 1,
                        totalAmount: this.totalAmount,
                        resourceType: 'CHARACTERISTIC_EXPERIENCE',
                    };
                    if (JSON.stringify(cancelPolicy !== {})) {
                        data['cancelPolicy'] = cancelPolicy;
                    }
                    this.$axios({...API_PLAY.bokingOther, data}).then(res => {
                        if (res.success) {
                            this.SET_NPP({
                            ...
                            if (this.form.payType === 'ADVANCE') {
                                ...
                                this.$nuxt.$router.push({
                                    name: 'personal_center-orderDetail-experience',
