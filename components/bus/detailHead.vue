<template>
    <div class="top">
        ...
        <!-- 大巴包车服务 -->
        <div :class="noborder? 'service':'service borderStyle'">
            <div class="imgShow">
                <img
                    :src="detailData.busImg?detailData.busImg:'~assets/public_img/img_home_adva2.png'"
                    alt="大车图片"
                />
            </div>
            <div class="words">
                ...
                <div class="context">
                    ...
                    <p class="gg" :title="detailData.facility">车辆设施：{{detailData.facility}}等</p>
                    <p class="gg" :title="detailData.busInfo">车辆：{{detailData.busInfo}}</p>
                    <p class="gg">司机语种：{{detailData.driverLanguageLocal}}</p>
                    <p class="gg">司机驾龄：{{detailData.drivingExperienceLocal}}</p>
                </div>
            </div>
        </div>

        <div :class="noborder? 'order':'order borderStyle'">
