    ...
    <div class="orderInfoRight">
        <div class="top">
            ...
            <div class="cell">
                ...
                <ul>
                    <li>
                        <div>类&emsp;&emsp;型：</div>
                        <p>{{detail.type}}</p>
                    </li>
                    <li>
                        <div>名&emsp;&emsp;称：</div>
                        <p>{{detail.name}}</p>
                    </li>
                    <li>
                        <div>使用日期：</div>
                        <p>{{detail.availableDate | mixin_f_formatDate('xxxx年xx月xx日')}}</p>
                    </li>
                    <li>
                        <div>支付方式：</div>
        ...
        <div class="bottom">
            <p>订单总额</p>
            <div><span>&yen;</span>{{detail.price*1 | mixin_f_formatNumber}}</div>
        </div>
    </div>
</template>
